...
<div
	class="z-20 {row ? 'max-h-[calc(100dvh-55px)] bg-amber-50' : 'h-0 max-h-0  '} transition-[max-height] fixed bottom-0 w-full border-t bg-lightgrey overflow-auto"
>
	{#if row}
		<div class="flex  flex-col">
			<div class="flex min-h-14 flex-col {row.isExpanded ? 'gap-6 overflow-auto ' : ' '} border-b">
				<div class="flex cursor-pointer items-center justify-between p-3">
